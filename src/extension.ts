...
const regex =
  /YYYY|YY|MMMM|MMM|MM|M|DD|D|hh|HH|h|wwww|www|mm|m|ss|s|f|F|a|A|-Z:Z:Z|Z:Z:Z|-Z:Z|Z:Z|-ZZZ|ZZZ|-ZZ|ZZ|-Z|Z|z/g;
...
function parseSelection(
  ...
  textEditor.selections.forEach((s) => {
    doc.validateRange(s) &&
      textEditorEdit.replace(s, generateLayout(doc.getText(s)));
  });
}
